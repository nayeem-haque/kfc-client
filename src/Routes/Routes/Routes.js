...
export const routes = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(`https://new-server-five.vercel.app/review/${params.id}`),
      },
      {
        path: "/myreviews",
        element: (
      ...
      {
        path: "/services",
        loader: () => fetch("https://new-server-five.vercel.app/services"),
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(`https://new-server-five.vercel.app/services/${params.id}`),
      },
      {
        path: "/reviews/:id",
